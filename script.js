...
const SCHOOL = "MyCollege";
// SCHOOL = "OtherCollege"; // error: const cannot be reassigned
console.log(SCHOOL);
...
console.log(2 + "3");
console.log(2 + 3);
// first two concatenate because + with a string turns the other value into string
...
//         - "Aged" if age > 35
// write code here
let ageStr = (typeof prompt === "function") ? prompt("Enter age:") : "20";
...
console.log(a);
// console.log(b); // b is not defined outside the block
